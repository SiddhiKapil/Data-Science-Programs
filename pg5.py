# SVM classifier
# Train an SVM classifier on the iris dataset using sklearn. Try different kernels and the
# associated hyperparameters. Train model with the following set of hyperparameters RBF
# kernel, gamma=0.5,
# one-vs-rest classifier, no-feature-normalization. Also try C=0.01,1,10C=0.01,1,10. For the
# above set of hyperparameters, find the best classification accuracy along with total number
# of support vectors on the test data
